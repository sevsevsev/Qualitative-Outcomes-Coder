...
{"sid": "S001", "outcomes": [{"text": "atomic outcome text", "code": "exact subcategory code or none", "confidence": "high|medium|low|none"}], "runner_up": "code or empty", "codebook_issue": "", "rationale": ""}
