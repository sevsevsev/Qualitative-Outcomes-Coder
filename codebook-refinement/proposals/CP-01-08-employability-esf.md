# CP-01-08: Cite the OCTAE Employability Skills Framework for 8.5
...
8.5 is labeled "(Perkins V / Soft Skills)". Perkins V is a funding statute, not a
...
| Before | After |
|---|---|
| `8.5 Employability Skills (Perkins V / Soft Skills)` (heading) | `8.5 Employability Skills` (the code string is unchanged; only the definitionsText heading's parenthetical changes) |
...
The code identifier `"8.5 Employability Skills"` in the `domains` array does not
